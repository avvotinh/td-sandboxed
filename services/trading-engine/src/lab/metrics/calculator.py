...
from src.lab.metrics.prop_firm_metrics import (
...
from src.lab.result import BreachEvent, TradeRecord
...
def _daily_pct_list(
    ...
    from src.lab.metrics.prop_firm_metrics import compute_daily_pnl_percentages
