...
from src.lab.data_cache import _SAFE_PATH_COMPONENT
from src.lab.job_config import _SUPPORTED_SYMBOLS
...
class _Frozen(BaseModel):
    ...
    Mirrors :class:`src.lab.job_config._Frozen` so dataset
