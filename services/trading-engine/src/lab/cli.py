...
from src.lab._cli_utils import (
    parse_date,
    parse_duration,
    read_yaml,
    result_to_json_dict,
...
from src.lab.job_config import BacktestJobConfig
...
from src.lab.walk_forward import WalkForward, WalkForwardFolds, WalkForwardResult
...
def run_cmd(
    ...
    if out is not None:
        if out.suffix.lower() == ".html":
            from src.lab.reports.html_writer import write_html_report
